...
public class PasswordFileEncryption2 implements Runnable {
	...
	public static void main(String[] args) {
		PasswordFileEncryption2 pfe = new PasswordFileEncryption2(args);
		pfe.run();
	}
	
	// constructor with command line argument options
	public PasswordFileEncryption2(String[] options) {
		String[] opArr;
